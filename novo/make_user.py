...
# Form implementation generated from reading ui file 'make_user.ui'
#
...
"")
        ...
        self.txt_user = QtWidgets.QLineEdit(self.edit_area)
        self.txt_user.setGeometry(QtCore.QRect(85, 90, 280, 50))
        font = QtGui.QFont()
        font.setFamily("Quicksand")
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_submit.setText(_translate("MainWindow", "CADASTRADO"))
        self.txt_user.setPlaceholderText(_translate("MainWindow", "USER"))
        self.txt_email.setPlaceholderText(_translate("MainWindow", "EMAIL"))
        self.txt_oldpass.setPlaceholderText(_translate("MainWindow", "PASSWORD"))
        self.txt_newpass.setPlaceholderText(_translate("MainWindow", "REPEAT PASSWORD"))
