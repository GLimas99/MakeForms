...
"border-radius: 10px;\n"
"color:rgb(200, 200, 255);")
        self.mid.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.mid.setFrameShadow(QtWidgets.QFrame.Shadow.Plain)
        ...
        self.lbl_welcome.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
...
"}")
        ...
        self.bot.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.bot.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        ...
        self.created.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
